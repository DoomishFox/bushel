 ...
 * @public
 */
export class UnmatchedMarkInputRule extends InputRule {
  ...
  private markHandler(
    ...
    if (!UnmatchedMarkInputRule.markApplies(state.doc, range, this.markType)) {
      return null;
    }
    ...
    const tr = state.tr.replaceWith(
      ...
      this.markType.schema.text(match[0]),
    );
