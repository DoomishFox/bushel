...
import { InclusiveExclusiveMarkInputRule } from "./InclusiveExclusiveMarkInputRule";
import { ZeroWidthSpace } from "./Characters";
...
export class BoldExtension extends MarkExtension<Strong> {
  ...
  public override proseMirrorMarkSpec(): MarkSpec {
    return {
      ...
      toDOM(): DOMOutputSpec {
        //const elem = new DOMNode()
        //return ["span", ZeroWidthSpace, ["strong", 0], ZeroWidthSpace];
        return ["strong"];
      },
    };
  }
